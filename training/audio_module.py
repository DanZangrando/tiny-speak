...
class PhonologicalPathwayLightning(pl.LightningModule):
    ...
    def validation_step(self, batch: Dict, batch_idx: int) -> torch.Tensor:  # noqa: D401
        return self._shared_step(batch, "val")

    def test_step(self, batch: Dict, batch_idx: int) -> torch.Tensor:  # noqa: D401
    ...
    def _pack_predictions(self, batch: Dict, logits: torch.Tensor) -> Dict[str, List]:
    ...
    # Buffers expuestos para análisis -----------------------------------
    @property
